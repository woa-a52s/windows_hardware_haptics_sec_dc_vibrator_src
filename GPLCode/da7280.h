...
typedef enum _DA7280_ACTUATOR_TYPE
{
	DA7280_LRA = 0,
	DA7280_ERM_BAR = 1,
	DA7280_ERM_COIN = 2,
	DA7280_DEV_MAX,
} DA7280_ACTUATOR_TYPE, * PDA7280_ACTUATOR_TYPE;

typedef enum _DA7280_OPERATION_MODE
{
	DA7280_INACTIVE = 0,
	DA7280_DRO_MODE = 1,
	DA7280_PWM_MODE = 2,
	...
	DA7280_ETWM_MODE = 4,
	DA7280_OPMODE_MAX
} DA7280_OPERATION_MODE, * PDA7280_OPERATION_MODE;

typedef struct _DA7280_GPI_CONTROL
{
	UCHAR seq_id;
	UCHAR mode;
	UCHAR polarity;
} DA7280_GPI_CONTROL, * PDA7280_GPI_CONTROL;

typedef struct _DA7280_CONFIGURATION
{
	DA7280_ACTUATOR_TYPE dev_type;
	DA7280_OPERATION_MODE dt_op_mode;
	UINT16 nommax;
	UINT16 absmax;
	UINT32 imax;
	UINT32 impd;
	...
	UCHAR ps_seq_id;
	UCHAR ps_seq_loop;
	DA7280_GPI_CONTROL gpi_ctl[3];
	UCHAR snp_mem[DA7280_SNP_MEM_SIZE];
	UINT32 seq_id_dur[DA7280_SEQ_ID_MAX + 1];
	BOOLEAN mem_update;
} DA7280_CONFIGURATION, * PDA7280_CONFIGURATION;
